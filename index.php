    ...
    <div class="container-fluid p-0">
        ...
        <div class="jumbotron jumbotron-fluid mb-5">
            <div class="container text-center py-5">
                <h1 class="text-white display-3">Home</h1>
            </div>
        </div>
        <!-- Header End -->
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <div class="text-center pb-2">
                    <h1 class="mb-4">Fitur-Fitur</h1>
                </div>
                <div class="row pb-3">
                    <a href="input-barang.php" class="">
                        <div class="ftr col-lg-3 col-md-6 text-center mb-5">
                            <div class="d-flex align-items-center justify-content-center bg-primary mb-4 p-4">
                                <h6 class="text-white font-weight-medium m-0">Input Barang</h6>
                            </div>
                    </a>
                    ...
                    <a href="input-kategori.php" class="">
                        <div class="col-lg-3 col-md-6 text-center mb-5">
                            <div class="d-flex align-items-center justify-content-center bg-primary mb-4 p-4">
                                <h6 class="text-white font-weight-medium m-0">Input Kategori</h6>
                            </div>
                    </a>
                    <p>Masukkan sebuah kategori</p>
                    </div>
                    <a href="list-kategori.php" class="">
                        <div class="col-lg-3 col-md-6 text-center mb-5">
                            <div class="d-flex align-items-center justify-content-center bg-primary mb-4 p-4">
                                <h6 class="text-white font-weight-medium m-0">List Kategori</h6>
                            </div>
                    </a>
                    <p>Lihat kategori-kategori yang telah dimasukkan</p>
                    </div>
                    <a href="input-transaksi.php" class="">
                        <div class="col-lg-3 col-md-6 text-center mb-5">
                            <div class="d-flex align-items-center justify-content-center bg-primary mb-4 p-4">
                                <h6 class="text-white font-weight-medium m-0">Input Transaksi</h6>
                            </div>
                    </a>
                    <p>Masukkan satu atau lebih transaksi</p>
                    </div>
                    <a href="detail-order.php" class="">
                        <div class="col-lg-3 col-md-6 text-center mb-5">
                            <div class="d-flex align-items-center justify-content-center bg-primary mb-4 p-4">
                                <h6 class="text-white font-weight-medium m-0">Detail Order</h6>
                            </div>
                    </a>
                    <p>Lihat detail-detail order yang telah dimasukkan</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="team card position-relative overflow-hidden border-0 mb-5">
                            ...
                            <div class="card-body text-center p-0">
                                <div class="team-text d-flex flex-column justify-content-center bg-secondary">
                                    <h5 class="font-weight-bold">Ardian Hafizh N.</h5>
                                    <span>2007714</span>
                                </div>
