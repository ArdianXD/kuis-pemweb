                    ...
                    if (mysqli_num_rows($result) > 0) {
                       ...
                       ?>
                        <tr>
                            ...
                            <td><a href="form-edit-barang.php?kode_barang=<?= $data['kode_barang']?>"><button class="btn btn-primary">Edit</button></a><a href="delete-barang.php?kode_barang=<?= $data['kode_barang']?>"><button class="btn btn-secondary">Hapus</button></a></td>
                        </tr>
                        <?php
                        $nomor++;}} else {?>
                            <td>Data Kosong</td>
